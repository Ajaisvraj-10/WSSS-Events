<template>
    <div class="project_dtls_main">
        <div class="top_nav_div_prjct_dtls">
    <div class="top_logo_box_prjct_dtls">
            <div class="inner_logo_prjct">
       ...
       <div class="mob_nav_menu_prjct" @click="show_sidebar=!show_sidebar">
  ...
  <path d="M3.5 4.66669H24.5V7.00002H3.5V4.66669ZM3.5 12.8334H24.5V15.1667H3.5V12.8334ZM3.5 21H24.5V23.3334H3.5V21Z" fill="#283618"/>
    ...
    <div class="underline" :class="{ active: hoveredItem === index }"></div>
        ...
        <router-link v-for="project in projectList"  :to="{ name: 'project', params: { id: project.id }}">
            <div class="projct_pstr_div_mre">
            <div class="poster_div_more">
                    <img :src="project.photo" alt="Project Photo">
                    <div class="postr_dtls_more">
                        <div class="pstr_txt_more">{{ project.title }}</div>
                        <div class="pstr_date_more">{{ project.date }}</div>
                    </div>
                </div>
            </div>
        </router-link>
         ...
         <!-- mob_footer -->
         <div class="mob_footer_div_prjct">
        <div class="mob_sect1_more">
